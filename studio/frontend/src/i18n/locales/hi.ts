  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        mlockNotApplicable: "लोड किया गया मॉडल पूरी तरह GPU पर है, इसलिए सिस्टम RAM में पिन करने योग्य कोई प्रति नहीं है और --mlock छोड़ दिया जाता है। “मॉडल को GPU मेमोरी में रखें” अब भी लागू है: निष्क्रिय होने पर स्वतः अनलोड बंद है।",
        mlockUngoverned: "लोड किया गया मॉडल ऐसे रनर का उपयोग करता है जिसके मेमोरी-प्लेसमेंट फ़्लैग मॉडल मेमोरी नियंत्रित नहीं करती। रेज़िडेंट रखें अब भी इमेज और वीडियो मॉडल के लिए निष्क्रिय स्वतः अनलोड बंद करता है। इसकी llama.cpp मेमोरी नीति अगले लोड किए गए llama.cpp मॉडल के लिए सहेजी रहती है।",
