  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        mlockNotApplicable: "النموذج المحمَّل موجود بالكامل على كرت الرسوميات، فلا توجد نسخة في ذاكرة النظام لتثبيتها ويُتخطى ‎--mlock‎. ولا يزال خيار إبقاء النموذج في ذاكرة كرت الرسوميات سارياً: التفريغ التلقائي عند الخمول معطَّل.",
        mlockUngoverned: "يستخدم النموذج المحمَّل مشغّلاً لا تتحكم «ذاكرة النموذج» في خيارات موضع الذاكرة الخاصة به. ويظل خيار إبقاء النموذج مقيماً يعطّل التفريغ التلقائي عند الخمول لنماذج الصور والفيديو. وتبقى سياسة ذاكرة llama.cpp محفوظة لنموذج llama.cpp التالي الذي تحمّله.",
