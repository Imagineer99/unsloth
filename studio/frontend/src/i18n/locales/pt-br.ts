  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        mlockUngoverned: "O modelo carregado usa um mecanismo cujas opções de posicionamento na memória não são controladas pela Memória do modelo. Manter residente ainda desativa a descarga automática por inatividade para modelos de imagem e vídeo. A política de memória do llama.cpp permanece salva para o próximo modelo llama.cpp carregado.",
